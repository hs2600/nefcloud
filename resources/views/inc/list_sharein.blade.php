...
//TODO: edit for share in intead of public share
...
if ($share != ''){
    ...
    if(!$result["Item"] == ""){
        ...
        echo '<p>&nbsp;</p><center><img src="/images/monkey.png">';
    ...
    echo '<p>&nbsp;</p><center><img src="/images/monkey.png">';
    echo "<br><span class='display-3'>Incorrect share code</span>";
    echo '<p>&nbsp;</p>';
    echo '<a href="/" class="btn btn-sm btn-info">Home</a>';
    echo '</center>';
    exit;
...
if(!$x == ''){
    echo '<a href="?dir='.$x.'" class="flex flex-column items-center justify-center color-inherit w-100 pa2 br2 br--top no-underline hover-bg-blue3 hover-white gray6" style="height: 100%;">';
...
foreach ($results->search($expression) as $i) {
    ...
    if(substr($i, -1) == "/"){
        if(substr_count($key, '/')+1 == substr_count($i, '/')){
            ...
            echo '<li style="width: 155px; height:180px; border:0px solid #e5e5e5; padding: 5px">';
            echo '<div class="shadow-hover hover-bg-white" style="border: 1px solid #e5e5e5; border-radius: 5px; background-color: #fcfcfc; height: 100%">';
            echo '  <a href="?dir='.$path.'" class="flex flex-column items-center justify-center color-inherit w-100 pa2 br2 br--top no-underline hover-bg-blue3 hover-white gray6" style="height: 135px;">';
            ...
            // echo '  </a>';
            // echo '  <a href="#" class="absolute bottom-1 right-025 '.$fav_color.' hover-yellow3" onclick="ajaxDBUpdate(\''.$afid.'\',\'favorite\')">';
        ...
        foreach ($result['Items'] as $i) {
            ...
            if(substr($item['Key'], -1) != "/"){
                ...
                if(substr_count($key, '/') == substr_count($item['Key'], '/')){
                    ...
                    // echo '  </a>';
                    // echo '  <a href="#" class="absolute bottom-1 right-025 '.$fav_color.' hover-yellow3" onclick="ajaxDBUpdate(\''.$file_id.'\',\'favorite\')">';
                    // echo '  <i class="fas fa-star" style="font-size: 12px;"></i>';
                    // echo '  </a>';                    
                    echo '</div></li>';
                }
